...
def train_with_batching(X_train, Y_train, X_val, Y_val, learning_rate=0.001, max_epochs=100000, tol=1e-10, batch_size=64, patience = 100):
    ...
    L3 = ReLULayer()
    L4 = FullyConnectedLayer(input_dim, input_dim)
    L5 = ReLULayer()
    L6 = FullyConnectedLayer(input_dim, input_dim)
    L7 = ReLULayer()
    L8 = FullyConnectedLayer(input_dim, input_dim)
    L9 = ReLULayer()
    L10 = FullyConnectedLayer(input_dim, input_dim)
    L11 = ReLULayer()
    L12 = FullyConnectedLayer(input_dim, input_dim)
    L13 = ReLULayer()
    L14 = FullyConnectedLayer(input_dim, input_dim)
    L15 = ReLULayer()
    L16 = FullyConnectedLayer(input_dim, output_dim)
    L17 = LinearLayer()
    L18 = SquaredError()
